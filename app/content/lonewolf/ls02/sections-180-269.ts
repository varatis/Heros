...
export const SECTIONS_180_269: StorySection[] = [
  ...
  texte: "Tandis que vous courez sur le pont jonché de cadavres, deux guerriers DRAKKARIM apparaissent soudain et vous attaquent par surprise. Il vous faut les combattre l'un après l'autre. Si vous tuez vos deux adversaires au cours du combat, vous pourrez ensuite sauter sur le pont d'un navire de Durenor qui passe à proximité.",
  suite: "185-b",
  choix: [
    { texte: "", vers: "120" }
  ],
  ...
  {
  id: "188",
  texte: "Votre présence d'esprit et votre adresse vous ont épargné une morsure fatale. Et tandis que le serpent disparaît dans les hautes herbes de l'autre côté de la route, vous ramassez vos affaires et vous grimpez à l'arbre dans le feuillage duquel vous passerez la nuit en toute sécurité.",
  choix: [
    { texte: "", vers: "312" }
  ]
  },
  ...
  {
  id: "205",
  texte: "L'aubergiste fronce les sourcils et vous montre du doigt une porte latérale. « Si vous ne pouvez pas vous payer une chambre, dit-il, allez donc dormir dans l'écurie. » En vous dirigeant vers la sortie, vous sentez dans votre dos le regard des autres passagers de la diligence. La porte claque sur vos talons et vous vous retrouvez seul dans la nuit froide, le corps parcouru de frissons.",
  choix: [
    { texte: "", vers: "213" }
  ]
  },
  {
  id: "206",
  texte: "Au cours de la nuit vous êtes réveillé par des loups qui hurlent au loin. Vous préférez ne pas prendre le risque d'être dévoré pendant votre sommeil et vous montez donc dans l'arbre pour passer le reste de la nuit à l'abri de son feuillage, à bonne distance du sol.",
  choix: [
    { texte: "", vers: "312" }
  ]
  },
  {
  id: "207",
  texte: "Moins de 100 mètres plus loin, le sentier s'arrête au bord d'un précipice. Les eaux du chenal de Ryner coulent au-dessous et il est impossible d'aller plus loin. Il ne vous reste donc plus qu'à rebrousser chemin et à prendre le pont qui traverse le chenal.",
  choix: [
    { texte: "", vers: "47" }
  ]
  },
  {
  id: "208",
  texte: "Vous passez devant le chariot et vous entendez soudain un bruit, juste derrière vous. Vous faites volte-face en observant attentivement les parois du tunnel, mais il fait trop sombre pour distinguer quoi que ce soit.",
  choix: [
    { texte: "", vers: "134" }
  ]
  },
  ...
  {
  id: "227",
  texte: "Quatre gardes de la ville, armés de pied en cap, marchent au milieu de la rue. Vous ne voulez pas courir le risque d'être interpellé et vous vous réfugiez dans une ruelle à votre gauche. Mais les soldats s'immobilisent juste à l'entrée du passage et il suffirait que l'un d'eux tourne la tête pour que vous soyez immédiatement repéré. Derrière vous, une petite fenêtre ouverte vous permet de distinguer l'intérieur d'une taverne bondée. Sans la moindre hésitation, vous enjambez aussitôt le rebord de la fenêtre et vous entrez à l'intérieur.",
  choix: [
    { texte: "", vers: "4" }
  ]
  },
  ...
  {
  id: "256",
  texte: "Vous passez devant les marches de pierre et vous poursuivez votre chemin. Vous venez de dépasser la plate-forme lorsque vous entendez un bruit au-dessus de votre tête. Vous vous immobilisez et vous levez les yeux, mais vous ne pouvez rien voir dans l'obscurité du tunnel.",
  choix: [
    { texte: "", vers: "134" }
  ]
  },
  ...
  {
  id: "259",
  texte: "A travers la pluie qui tombe à verse, vous parvenez à distinguer la silhouette d'un groupe de soldats qui s'avancent dans votre direction. Vous ne voulez pas prendre le risque d'être interpellé et peut-être arrêté, vous décidez donc de vous réfugier dans une boutique proche.",
  choix: [
    { texte: "", vers: "161" }
  ]
  },
