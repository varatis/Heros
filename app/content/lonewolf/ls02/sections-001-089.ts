...
export const SECTIONS_001_89: StorySection[] = [
  ...
  {
    "id": "3",
    "texte": "Vous sortez dans une petite ruelle, derrière la boutique et vous voyez, tout au bout, un cheval attaché à un piquet par une longe. Si vous souhaitez prendre ce cheval et fuir le village, rendez-vous au 150. Si le cheval ne vous intéresse pas, quittez la ruelle et rendez-vous au 19.",
    "choix": [
      {
        "texte": "Si vous souhaitez prendre ce cheval et fuir le village",
        "vers": "150"
      },
      {
        "texte": "Si le cheval ne vous intéresse pas, quittez la ruelle et",
        "vers": "19"
      }
    ]
  },
  ...
  {
    "id": "5",
    "texte": "La porte s'ouvre à la volée et un MONSTRE d'ENFER se rue sur vous en brandissant son épée. Vous frappez la créature dès qu'elle a pénétré dans la cale et sous l'effet du coup, une longue et profonde entaille apparaît sur sa poitrine. Le Monstre pousse un cri épouvantable, mais, malgré sa blessure, il a encore la force de bondir sur vous. Il vous faut engager un combat à mort. MONSTRE BLESSÉ HABILETÉ: 22 ENDURANCE: 20 Le Monstre d'Enfer est un être de l'au-delà, un mort vivant, et la puissance du Glaive de Sommer vous permet de multiplier par deux tous les points d'ENDURANCE qu'il perdra au cours du combat. Il est cependant insensible à la Puissance Psychique. Si vous parvenez à tuer le Monstre, vous pourrez vous enfuir de la cale par l'écoutille. Rendez- vous alors au 166.",
    "combat": {
      "nom": "Monstre d'Enfer blessé",
      "habilete": 22,
      "endurance": 20,
  ...
  {
    "id": "6",
    "texte": "Le garçon a remarqué que vous le suiviez et dès qu'il est sorti, il tourne le coin du bâtiment et se met à courir en direction du sud. Vous vous lancez à sa poursuite, mais il a tôt fait de disparaître dans le dédale des allées qui longent les entrepôts du port. Vous vous dirigez vers l'est en empruntant la rue du Col Vert et vous passez devant une autre entrée du magasin. Un peu plus loin, vous remarquez une enseigne au-dessus de la porte d'une petite boutique. On peut y lire l'inscription suivante : MEKI MAJENOR MAÎTRE ARMURIER Si vous souhaitez entrer dans cette boutique, rendez-vous au 266. Si vous préférez poursuivre votre chemin en direction de l'est, rendez- vous au 310.",
    "choix": [
      {
        "texte": "On peut y lire l'inscription suivante : MEKI MAJENOR MAÎTRE ARMURIER Si vous souhaitez entrer dans cette boutique",
        "vers": "266"
      },
      {
        "texte": "Si vous préférez poursuivre votre chemin en direction de l'est",
        "vers": "310"
      }
    ]
  },
  {
    "id": "7",
    "texte": "DORIER s'écarte d'un bond de la table et tire son épée. Un instant plus tard, son frère GANON vient à sa rescousse. Il vous faut les combattre tous deux comme s'il s'agissait d'un seul adversaire. DORIER GANON HABILETÉ: 28 ENDURANCE: 30 Votre attaque soudaine vous donne un avantage en raison de l'effet de surprise. Vous ajouterez de ce fait 2 points à votre total d'HABILETÉ, mais seulement lors du premier assaut. Au cours des assauts suivants, votre total d'HABILETÉ reviendra à son niveau antérieur. L'entraînement que les deux hommes ont suivi pour devenir Chevaliers leur a donné une force mentale qui les met à l'abri de la Puissance Psychique. Si vous sortez vainqueur de ce combat, rendez-vous au 33.",
    "combat": {
      "nom": "Dorier et Ganon",
      "habilete": 28,
      "endurance": 30,
  ...
  {
    "id": "13",
    "texte": "Votre sens de l'orientation vous indique qu'il faut prendre le chemin de gauche pour parvenir au plus vite à Port Bax. Vous calez votre Sac à Dos sur vos épaules et vous vous remettez en route. Rendez-vous au 155.",
    "suite": "155"
  },
  {
    "id": "14",
  ...
  {
    "id": "18",
    "texte": "Un peu plus loin, la rue est complètement bloquée par des chariots que l'on décharge pour transborder la marchandise sur un navire de commerce. Vous poursuivez votre chemin ; la rue tourne bientôt vers l'est pour aboutir à la rue du Col Vert. A votre gauche, vous remarquez une autre entrée par laquelle on peut pénétrer dans le magasin de Ragadorn. Au-delà se trouve une petite boutique avec cette enseigne accrochée au-dessus de la porte : MEKI MAJENOR — MAÎTRE ARMURIER. Si vous souhaitez entrer dans le magasin de Ragadorn, rendez-vous au 173. Si vous préférez pénétrer dans la boutique de l'armurier, rendez- vous au 266. Si enfin vous décidez plutôt de poursuivre votre chemin en direction de l'est, rendez-vous au 310.",
    "choix": [
      {
        "texte": "Si vous souhaitez entrer dans le magasin de Ragadorn",
        "vers": "173"
      },
      {
        "texte": "Si vous préférez pénétrer dans la boutique de l'armurier",
        "vers": "266"
      },
      {
        "texte": "Si enfin vous décidez plutôt de poursuivre votre chemin en direction de l'est",
        "vers": "310"
      }
    ]
  },
  ...
  {
    "id": "22",
    "texte": "Au matin, vous êtes réveillé par un cri de l'homme de quart : « Naufrage par tribord avant ! » Vous vous habillez en hâte et vous montez sur le pont pour rejoindre le capitaine qui se tient debout devant le bastingage de la proue. Utilisez la Table de Hasard pour obtenir un chiffre. Si vous tirez 0,1,2,3 ou 4, rendez-vous au 119. Si vous tirez 5, 6, 7, 8 ou 9, rendez-vous au 341.",
    "evenement": {
      "type": "jet-hasard-table",
      "branches": {
        "0-4": {
  ...
  {
    "id": "24",
    "texte": "C'est le tombeau de Killean le Suzerain. Il était l'un des seigneurs de Ragadorn jusqu'au jour où, trois ans plus tôt, une épidémie de peste rouge l'emporta en même temps que nombre de ses compatriotes. Vous vous rappelez soudain les récits que vous a faits un certain Renard Agile qui occupait un emploi d'artisan au monastère Kaï. Cet homme s'était souvent rendu à Ragadorn et la peste rouge l'avait frappé tout comme elle avait frappé une bonne moitié de la population locale. Si vous souhaitez retourner dans la taverne, rendez-vous au 177. Si vous préférez poursuivre votre chemin le long de la rue du Tombeau, rendez- vous au 253. Si enfin vous désirez prendre la direction de l'est en empruntant la rue de la Tour de Guet, rendez-vous au 319.",
    "choix": [
      {
        "texte": "Si vous souhaitez retourner dans la taverne",
        "vers": "177"
      },
      {
        "texte": "Si vous préférez poursuivre votre chemin le long de la rue du Tombeau",
        "vers": "253"
      },
      {
        "texte": "Si enfin vous désirez prendre la direction de l'est en empruntant la rue de la Tour de Guet",
        "vers": "319"
      }
    ]
  },
  {
    "id": "25",
    "texte": "Vous parcourez du regard la taverne où s'entasse une foule de buveurs, et vous remarquez que de nombreux villageois jouent à des jeux de hasard. Près de l'entrée principale, un jeune personnage à l'allure louche est assis devant une table sur laquelle trois tasses d'argile sont retournées. Il les change sans cesse de place en mettant au défi qui veut l'entendre de deviner sous laquelle de ces trois tasses est cachée une bille de verre. Il promet de donner au gagnant le double de la somme que ce dernier aura misée. Si vous possédez les Disciplines Kaï du Sixième Sens ou de la Maîtrise Psychique de la Matière, rendez-vous au 116. Si ces deux Disciplines vous sont étrangères, rendez-vous au 153.",
    "choix": [
      {
        "vers": "116",
        "texte": "Si la condition du texte est remplie",
  ...
  {
    "id": "28",
    "texte": "Les Squalls se mettent à hurler de terreur et s'enfuient en tous sens pour éviter vos coups. En quelques instants, ils ont déserté la clairière et vous vous approchez du moribond pour lui porter secours. Il lui reste tout juste un souffle de vie et il est bien entendu beaucoup trop faible pour parler. Si vous voulez retirer avec précaution la lance de sa poitrine, rendez-vous au 106. Si vous préférez fouiller dans son sac dans l'espoir d'y trouver quelque objet qui pourrait se révéler utile, rendez-vous au 320.",
    "choix": [
      {
        "texte": "Si vous voulez retirer avec précaution la lance de sa poitrine",
        "vers": "106"
      },
      {
        "texte": "Si vous préférez fouiller dans son sac dans l'espoir d'y trouver quelque objet qui pourrait se révéler utile",
        "vers": "320"
      }
    ]
  },
  ...
  {
    "id": "35",
    "texte": "Vous enjambez le soldat évanoui et vous vous hâtez de fuir la tour en direction de la forêt car si d'autres gardes apparaissent, il y a tout à parier qu'ils vous attaqueront avant de vous poser des questions. Vous avez marché pendant plus de deux heures lorsque vous parvenez à une bifurcation, à proximité d'un chêne rabougri. Si vous décidez d'aller à gauche, rendez-vous au 155. Si vous préférez aller à droite, rendez- vous au 293. Enfin, si vous maîtrisez la Discipline Kaï de l'Orientation, rendez-vous au 13.",
    "choix": [
      {
        "texte": "Si vous décidez d'aller à gauche",
        "vers": "155"
      },
      {
  ...
  },
  {
    ...
    "choix": [
      ...
      {
        "vers": "275",
        "texte": "Ni herbe de Laumspur, ni Guérison",
        "requis": {
          "non": {
            "auMoinsUn": [
              {
  ...
  },
  {
    ...
    "choix": [
      {
        "texte": "Si vous voulez marcher en direction du nord, le long de la rue de la porte Ouest",
        "vers": "122"
      },
      {
        "texte": "Si vous préférez aller vers le sud en empruntant la promenade du quai de l'Est",
        "vers": "323"
      },
      {
        "texte": "Enfin, si vous décidez plutôt de vous orienter vers l'est en prenant la rue de la Hache",
        "vers": "257"
      }
    ]
  },
  {
    "id": "38",
    "texte": "Vous saisissez la hampe de la lance que vous enfoncez dans la cage thoracique du Monstre d'Enfer. Celui-ci se met à hurler de douleur et de rage en relâchant l'étreinte de ses doigts autour de votre cou. Vous roulez alors sur vous-même pour échapper au Monstre hideux que vous voyez se tordre sur le sol en essayant désespérément d'arracher la lance de sa poitrine. Si vous souhaitez empoigner la lance pour l'enfoncer plus profondément dans le corps du Monstre d'Enfer, rendez-vous au 269. Si vous préférez prendre la fuite le plus vite possible, rendez-vous au 313.",
    "choix": [
      {
        "texte": "Si vous souhaitez empoigner la lance pour l'enfoncer plus profondément dans le corps du Monstre d'Enfer",
        "vers": "269"
      },
      {
        "texte": "Si vous préférez prendre la fuite le plus vite possible",
        "vers": "313",
        "effets": {
          "retirerObjets": [
            "lance-magique"
  ...
  {
    "id": "39",
    "texte": "A la tombée du jour, la diligence s'arrête devant une auberge sur la route qui longe la côte en direction de Port Bax. Le prix d'une chambre pour la nuit s'élève à 1 Couronne d'Or pour les passagers de la diligence et à 3 Couronnes pour les autres clients. Au moment où vous vous apprêtez à entrer, le conducteur de la diligence vous demande votre billet. Si vous avez un billet pour Port Bax, rendez-vous au 346. Si vous n'avez pas de billet, rendez-vous au 156.",
    "choix": [
      {
        "vers": "346",
        "texte": "Si la condition du texte est remplie",
        "requis": {
          "objet": "billet-port-bax"
        }
      },
      {
        "vers": "156",
  ...
  },
  {
    ...
    "choix": [
      ...
      {
        "texte": "Si vous préférez rester éveillé et scruter la mer dans l'espoir de retrouver d'autres survivants du naufrage",
        "vers": "251"
      }
    ]
  },
  {
    "id": "42",
    "texte": "Vous devinez que quelqu'un se cache au sommet de la falaise, juste au- dessus de vous ; vous sentez également que vous étiez la victime désignée de cet attentat. On veut vous tuer, vous en avez la certitude ! Rendez-vous au 168.",
    "suite": "168"
  },
  {
    "id": "43",
  ...
  {
    "id": "46",
    "texte": "Vous vous efforcez de vous rappeler la signification de cette porte orange, mais sans succès. Si vous décidez d'entrer dans la boutique, rendez-vous au 214. Si vous préférez poursuivre votre chemin, rendez- vous au 230.",
    "choix": [
      {
        "texte": "Si vous décidez d'entrer dans la boutique",
        "vers": "214"
      },
      {
  ...
  {
    "id": "47",
    "texte": "Les soldats se hâtent de descendre du toit et empoignent leurs lances ; puis ils s'avancent vers vous. « Le mot de passe, étranger ! » crie l'un d'eux. Si vous connaissez le mot de passe qui permet de franchir le pont, rendez-vous au 111. Sinon, rendez-vous au 307.",
    "choix": [
      {
        "vers": "111",
        "texte": "Si la condition du texte est remplie",
  ...
  },
  {
    ...
    "fin": "mort",
    "nomFin": "Fin de la mission — §54"
  },
  {
    "id": "55",
    "texte": "Un homme de haute taille vêtu d'un tablier de cuir est en train d'aiguiser un glaive de belle apparence. L'homme est assis devant une meule qui projette des gerbes d'étincelles chaque fois que la lame de l'épée entre en contact avec la pierre. Le forgeron vous souhaite le bonsoir et vous offre le glaive. « Cest une belle lame, dit-il, forgée dans un pur acier de Durenor. Pour douze Couronnes, elle est à vous. » Si vous souhaitez acheter ce glaive, inscrivez-le sur votre Feuille d'Aventure et soustrayez douze Couronnes de votre total de Pièces d'Or. Si vous décidez de quitter la boutique par la porte principale, rendez-vous au 347. Si vous préférez passer par la porte de derrière, rendez-vous au 3.",
    "evenement": {
      "type": "interaction",
      "interaction": {
        "type": "boutique",
    ...
    "choix": [
      {
        "texte": "Si vous décidez de quitter la boutique par la porte principale",
        "vers": "347"
      },
      {
        "texte": "Si vous préférez passer par la porte de derrière",
        "vers": "3"
      }
    ]
  },
  ...
  {
    "id": "59",
    "texte": "A coups d'éperons, vous lancez votre cheval en direction d'un Monstre d'Enfer qui s'apprête à frapper un soldat sans défense. Cette créature est insensible à la Discipline Kaï de la Puissance Psychique et ne peut être blessée que par une arme magique. Si vous possédez une Lance Magique, rendez-vous au 332. Dans le cas contraire, il vous faut prendre la fuite en plongeant dans les broussailles pour vous y cacher ; rendez-vous alors au 311.",
    "choix": [
      {
        "vers": "332",
        "texte": "Si la condition du texte est remplie",
  ...
  {
    "id": "60",
    "texte": "HALVORC vous contemple d'un air stupéfait et incrédule. HALVORC HABILETÉ: 8 ENDURANCE: 11 Il est incapable de se défendre au cours des deux premiers assauts en raison de l'effet de surprise de votre attaque. Vous ne perdrez donc aucun point d'ENDURANCE lors de ces deux assauts. Si votre adversaire est toujours en vie au moment du troisième assaut, il s'élancera sur vous armé d'un Poignard. Si vous sortez vainqueur du combat, rendez-vous au 76.",
    "combat": {
      "nom": "Halvorc",
      "habilete": 8,
      "endurance": 11,
      "sansDefenseAssauts": 2
    },
    "suite": "76"
  },
  {
    "id": "61",
    "texte": "La pluie tombe si dru qu'il vous est difficile de voir distinctement ; vous apercevez cependant les silhouettes sombres de gardes en patrouille qui s'avancent dans votre direction. S'ils vous arrêtaient pour vous demander ce que vous êtes venu faire à Ragadorn, vous pourriez bien finir dans l'une des nombreuses geôles de Lachelan le Suzerain. Il vaut mieux ne pas courir ce risque et vous décidez donc de battre en retraite le long de la rue du Chevalier Noir et de bifurquer le plus vite possible dans la rue du Sage ; votre tactique réussit et les gardes passent sans vous voir. Rendez-vous à présent au 181.",
    "suite": "181"
  },
  {
    "id": "62",
    "texte": "Vous entrez dans une vaste pièce remplie de classeurs et de livres de comptes. Face à vous, un homme revêtu d'un uniforme d'officier des forces navales de Durenor est assis à un grand bureau. Il tient devant lui un énorme livre posé debout sur le bureau. A votre entrée, l'homme lève les yeux de son livre et vous jette un regard inquisiteur. « Vous devez avoir des affaires bien urgentes à mener pour solliciter un laissez-passer rouge à une heure aussi tardive. Je voudrais voir votre permis d'entrée et l'autorisation de votre officier commandant. » Si vous avez réuni ces documents au cours de votre quête, rendez-vous au 126. Si vous n'avez pas les documents demandés, ou si vous ne souhaitez pas les présenter à cet homme, vous devrez prendre le risque de lui montrer le Sceau d'Hammardal et vous rendre dans ce cas au 263. Si vous n'avez ni le Sceau ni les documents, quittez la pièce et retournez dans le hall en vous rendant au 318.",
    "choix": [
      {
        "vers": "126",
        "texte": "Présenter les documents",
        "requis": {
          "objet": "documents-port-bax"
        }
      },
      {
        "vers": "263",
        "texte": "Montrer le Sceau d'Hammardal",
        "requis": {
  ...
  {
    "id": "63",
    "texte": "Vous êtes réveillé au milieu de la nuit par un poids qui pèse soudain sur votre poitrine. Vous écartez lentement les pans de votre cape et vous découvrez avec horreur qu'un Serpent des Sables s'est niché dessous. Si vous voulez essayer d'attraper ce serpent au venin mortel juste derrière la tête et le jeter au loin, rendez-vous au 188. Si vous préférez vous lever d'un bond en essayant de faire tomber le serpent sur le sol, rendez-vous au 201. Si vous maîtrisez la Discipline Kaï de la Communication Animale, rendez-vous au 264.",
    "choix": [
      {
        "texte": "Si vous voulez essayer d'attraper ce serpent au venin mortel juste derrière la tête et le jeter au loin",
        "vers": "188"
      },
      {
        "texte": "Si vous préférez vous lever d'un bond en essayant de faire tomber le serpent sur le sol",
        "vers": "201"
      },
      {
  ...
  {
    "id": "64",
    "texte": "Un peu plus loin, vous apercevrez une diligence semblable à celles qui transportent les voyageurs le long des côtes menant à Ragadorn. Les chevaux ont été dételés et le véhicule semble abandonné. Vous remarquez alors les corps de trois soldats étendus entre les roues. Leurs uniformes sont tachés de sang. Si vous souhaitez fouiller la diligence en espérant y trouver de la nourriture ou quelque objet utile, rendez-vous au 134. Si vous préférez poursuivre votre chemin sans vous attarder, rendez-vous au 208. Si enfin vous maîtrisez la Discipline Kaï du Sixième Sens, rendez-vous au 229.",
    "choix": [
      {
        "texte": "Si vous souhaitez fouiller la diligence en espérant y trouver de la nourriture ou quelque objet utile",
        "vers": "134"
      },
      {
        "texte": "Si vous préférez poursuivre votre chemin sans vous attarder",
        "vers": "208"
      },
      {
        "texte": "Si enfin vous maîtrisez la Discipline Kaï du Sixième Sens",
        "vers": "229",
        "requis": {
          "discipline": "sixieme-sens"
        }
  ...
  {
    "id": "70",
    "texte": "Vous haletez de douleur lorsque le serpent plonge ses crochets dans votre bras. Vous saisissez le reptile juste derrière sa tête repoussante, vous l'arrachez à votre bras et vous le jetez dans l'herbe. Mais le serpent a eu le temps de vous infliger une profonde morsure et son venin commence à faire de l'effet. Si vous possédez le Pendentif à l'Étoile de Cristal, rendez-vous au 219. Dans le cas contraire, rendez-vous au 44.",
    "choix": [
      {
        "vers": "219",
        "texte": "Si la condition du texte est remplie",
  ...
  {
    "id": "71",
    "texte": "Vous claquez la porte derrière vous et vous poussez le verrou. La boutique est sombre, mais vous parvenez cependant à distinguer un escalier à votre droite, une trappe au milieu du plancher et une porte dans le mur du fond. Soudain, vous entendez le fracas d'une hache qui vient de briser un panneau de la porte d'entrée. On vous a vu entrer dans la boutique et la populace est en train de défoncer la porte. Si vous souhaitez ouvrir la trappe et vous cacher dans la cave, rendez-vous au 11. Si vous préférez quitter la boutique par la porte du fond, rendez- vous au 54. Enfin, si vous décidez plutôt de monter l'escalier, rendez- vous au 235.",
    "choix": [
      {
        "texte": "Si vous souhaitez ouvrir la trappe et vous cacher dans la cave",
        "vers": "11"
      },
      {
        "texte": "Si vous préférez quitter la boutique par la porte du fond",
        "vers": "54"
      },
      {
        "texte": "Enfin, si vous décidez plutôt de monter l'escalier",
        "vers": "235"
      }
    ]
  },
  {
    "id": "72",
    "texte": "L'aubergiste prend votre Pièce d'Or et pose devant vous une chope de bière mousseuse. C'est une bière forte et revigorante qui vous redonne un point d'ENDURANCE. Si vous souhaitez parler à l'aubergiste, rendez-vous au 226. Si vous désirez prendre une chambre pour la nuit, il vous en coûtera 2 Pièces d'Or et vous vous rendrez au 56. Si enfin vous souhaitez engager une partie de bras de fer, rendez-vous au 276.",
    "effets": {
      "endurance": 1
    },
    "choix": [
      {
        "texte": "Si vous souhaitez parler à l'aubergiste",
        "vers": "226"
      },
      {
        "texte": "Si vous désirez prendre une chambre pour la nuit, il vous en coûtera 2 Pièces d'Or et vous vous rendrez",
        "vers": "56",
        "requis": {
          "or": 2
        },
      ...
      {
        "texte": "Si enfin vous souhaitez engager une partie de bras de fer",
        "vers": "276"
      }
    ]
  },
  ...
  },
  {
    ...
    "choix": [
      {
        "texte": "» Si vous désirez signer ces papiers et faire l'achat d'un laissez-passer blanc, inscrivez-le sur votre Feuille d'Aventure, soustrayez les 10 Pièces d'Or qu'il vous aura coûté et",
        "vers": "142",
        "requis": {
          "or": 10
        },
      ...
      {
        "texte": "Si vous n'avez pas assez d'argent ou si ce laissez-passer ne vous intéresse pas, quittez le bureau et retournez dans le hall en vous rendant",
        "vers": "318"
      }
    ]
  },
  ...
  {
    "id": "77",
    "texte": "Au cours de votre entraînement au monastère Kaï, vos maîtres vous ont enseigné de nombreux langues et dialectes en usage dans les régions septentrionales de Magnamund. L'un de ces dialectes est le squall. Or, il se trouve précisément que les créatures rassemblées dans cette clairière sont des Squalls. A grands cris, ils vous expliquent que l'homme blessé n'a en réalité rien d'humain. C'est un Monstre d'Enfer, affirment-ils, un de ces êtres maléfiques qui ont le pouvoir de changer de forme à leur guise et qui comptent parmi les plus fidèles serviteurs des Maîtres des Ténèbres. Si vous pensez que les Squalls disent vrai, jetez un coup d'œil au contenu du sac de l'homme blessé en vous rendant au 320. Si en revanche vous soupçonnez les Squalls de vous mentir pour vous dissuader d'intervenir dans leurs jeux répugnants, attaquez-les avec votre arme en vous rendant au 28.",
    "choix": [
      {
        "texte": "Si vous pensez que les Squalls disent vrai, jetez un coup d'œil au contenu du sac de l'homme blessé en vous rendant",
        "vers": "320"
      },
      {
        "texte": "Si en revanche vous soupçonnez les Squalls de vous mentir pour vous dissuader d'intervenir dans leurs jeux répugnants, attaquez-les avec votre arme en vous rendant",
        "vers": "28"
      }
    ]
  },
  ...
  },
  {
    ...
    "choix": [
      ...
      {
        "texte": "Si vous n'avez plus le Sceau ou si vous ne voulez pas le lui montrer",
        "vers": "189"
      }
    ]
  },
  ...
  {
    "id": "83",
    "texte": "Au bout de la rue de la Bernicle, vous arrivez à un croisement. Il fait déjà nuit à présent et il va bientôt falloir vous trouver un abri. Si vous souhaitez tourner à gauche, dans la rue du Tonnelier, rendez-vous au 227. Si vous préférez prendre à droite la rue de la Licorne, rendez-vous au 297.",
    "choix": [
      {
        "texte": "Si vous souhaitez tourner à gauche, dans la rue du Tonnelier",
        "vers": "227"
      },
      {
        "texte": "Si vous préférez prendre à droite la rue de la Licorne",
        "vers": "297"
      }
    ]
  },
  {
    "id": "84",
    "texte": "Dans l'entrée principale, un vieil homme est assis ; il arbore une longue barbe et semble fort aimable. Penché sur un lutrin, il est en train d'étudier un énorme livre à la reliure de cuir. Sa lecture l'absorbe tant qu'il n'a pas remarqué votre présence dans l'enceinte de l'hôtel de ville. Si vous souhaitez lui demander le chemin du consulat du Sommerlund, rendez-vous au 211. Si vous préférez repartir et trouver vous-même votre chemin, rendez-vous au 191.",
    "choix": [
      {
        "texte": "Si vous souhaitez lui demander le chemin du consulat du Sommerlund",
        "vers": "211"
      },
      {
        "texte": "Si vous préférez repartir et trouver vous-même votre chemin",
        "vers": "191"
      }
    ]
  },
  {
    "id": "85",
    "texte": "VIVEKA renverse la table d'un coup de pied. Elle est rapide comme l'éclair et votre effet de surprise est complètement raté. Elle a déjà dégainé son épée et se jette sur vous. VIVEKA HABILETÉ : 24 ENDURANCE : 27 Si vous remportez la victoire, rendez-vous au 124.",
    "combat": {
      "nom": "Viveka",
      "habilete": 24,
      "endurance": 27
  ...
  },
  {
    ...
    "choix": [
      {
        "texte": "Si vous souhaitez aller vers l'est, le long de la rue de la Bernicle",
        "vers": "215"
      },
      {
        "texte": "Si vous préférez aller au sud, en suivant le Dock de la rive Ouest",
        "vers": "303"
      },
      {
        "texte": "Enfin, si vous choisissez plutôt de prendre la direction du nord en empruntant la rue du Butin",
        "vers": "129"
      }
    ]
  },
  {
    ...
    "fin": "mort",
    "nomFin": "Fin de la mission — §87"
  },
  {
    "id": "88",
    "texte": "Bien que la nuit soit tombée, la pleine lune projette une brillante clarté sur tout le village. Derrière la taverne, vous apercevez la petite boutique d'un charron ; deux chevaux sont attelés à une charrette à foin stationnée juste devant la porte. Si vous souhaitez prendre l'un des chevaux pour vous enfuir au galop, rendez-vous au 150. Si vous préférez vous cacher dans la boutique du charron, rendez-vous au 71. Si enfin vous maîtrisez la Discipline Kaï du Camouflage, rendez-vous au 179.",
    "choix": [
      {
        "texte": "Si vous souhaitez prendre l'un des chevaux pour vous enfuir au galop",
        "vers": "150"
      },
      {
        "texte": "Si vous préférez vous cacher dans la boutique du charron",
        "vers": "71"
      },
      {
        "texte": "Si enfin vous maîtrisez la Discipline Kaï du Camouflage",
        "vers": "179",
        "requis": {
  ...
  {
    "id": "89",
    "texte": "Au moment où vous sautez, le conducteur vous aperçoit et arrête aussitôt la diligence. Puis il se tourne vers vous, une épée à la main. Si vous souhaitez lui payer le prix d'un billet, rendez-vous au 233. Si vous préférez l'attaquer, rendez-vous au 212.",
    "choix": [
      {
        "texte": "Si vous souhaitez lui payer le prix d'un billet",
        "vers": "233"
      },
      {
        "texte": "Si vous préférez l'attaquer",
        "vers": "212"
      }
    ]
  }
