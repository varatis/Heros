...
export const SECTIONS_090_179: StorySection[] = [
  ...
  {
  id: "91-a",
  titre: "Premier objet offert",
  texte: "Le marchand vous remercie de lui avoir rendu service et dispose devant vous la liste promise : Bâton, Couverture, 2 Repas, Poignard, 100 mètres de Corde. Vous pouvez choisir deux objets — inscrivez le premier.",
  choix: [
    { texte: "Prendre le Bâton", vers: "91-b", effets: { objets: [{"id":"baton"}] } },
    { texte: "Prendre la Couverture", vers: "91-b", effets: { objets: [{"id":"couverture"}] } },
    { texte: "Prendre 2 Repas", vers: "91-b", effets: { objets: [{"id":"repas","quantity":2}] } },
    { texte: "Prendre le Poignard", vers: "91-b", effets: { objets: [{"id":"poignard"}] } },
    { texte: "Prendre 100 mètres de Corde", vers: "91-b", effets: { objets: [{"id":"corde"}] } }
  ]
  },
  {
  id: "91-b",
  titre: "Second objet offert",
  texte: "« Et pour le second ? » demande le marchand en souriant.",
  choix: [
    { texte: "Prendre le Bâton", vers: "245", effets: { objets: [{"id":"baton"}] } },
    { texte: "Prendre la Couverture", vers: "245", effets: { objets: [{"id":"couverture"}] } },
    { texte: "Prendre 2 Repas", vers: "245", effets: { objets: [{"id":"repas","quantity":2}] } },
    { texte: "Prendre le Poignard", vers: "245", effets: { objets: [{"id":"poignard"}] } },
    { texte: "Prendre 100 mètres de Corde", vers: "245", effets: { objets: [{"id":"corde"}] } }
  ]
  },
  {
  id: "92",
  ...
  choix: [
    ...
    { texte: "Si vous préférez plonger dans la mer et tenter de gagner à la nage un autre navire de la flotte de Durenor", vers: "267" }
  ]
  },
  {
  id: "101",
  ...
  choix: [
    { texte: "Si vous souhaitez continuer à les poursuivre", vers: "231" },
    { texte: "Si vous préférez les laisser partir", vers: "177" }
  ]
  },
  {
  id: "105",
  texte: "Malheureusement pour vous, la corde a été presque coupée en deux par un coup d'épée et il faut craindre qu'elle ne casse sous votre poids. Utilisez la Table de Hasard pour obtenir un chiffre qui vous indiquera si la corde a tenu bon ou pas.",
  evenement: {
        type: "jet-hasard-table",
        branches: {
        "0-4": { vers: "286", texte: "Si vous tirez un chiffre entre 0 et 4," },
  ...
  {
  id: "110",
  texte: "Le GARDE ne vous croit pas et se rue sur vous, son épée à la main. Si vous ne possédez pas d'arme, retranchez 4 points de votre total d'habileté pendant toute la durée du combat.",
  suite: "331",
  combat: { nom: "Garde de la Tour", habilete: 15, endurance: 22, fuite: [{ texte: "Prendre la fuite", vers: "65" }] }
  },
  {
  id: "111",
  ...
  evenement: {
        type: "jet-hasard-table",
        titre: "Le jeu des tasses",
        texte: "Table de Hasard + 5 : voilà combien de Pièces d'Or vous gagnez avant que le fripon ne mette fin au jeu.",
        ton: "joie",
        branches: {
        "0-0": { or: 5 },
        "1-1": { or: 6 },
  ...
  choix: [
    ...
    { texte: "Laisser repartir la diligence et continuer à pied", vers: "292", montreToujours: true }
  ]
  },
  {
  id: "118",
  ...
  choix: [
    ...
    { texte: "Si vous préférez la laisser filer sans vous en soucier et poursuivre votre chemin", vers: "340" },
    { texte: "Si vous maîtrisez la Discipline Kaï de la Communication animale", vers: "279", requis: {"discipline":"communication-animale"} }
  ]
  },
  {
  id: "119",
  ...
  {
  id: "122",
  texte: "Cette rue longe les murs de la ville en direction du nord. Sur votre droite, vous remarquez une boutique dont la porte est de couleur orange. A la différence des autres boutiques de la rue, celle-ci ne porte aucune enseigne. C'est alors que vous revient en mémoire le récit qu'un Seigneur Kaï vous avait fait il y a environ un an à son retour d'un voyage dans la ville de Ragadorn. Il vous avait parlé de cette porte orange à plusieurs reprises. Utilisez la Table de Hasard pour obtenir un chiffre.",
  choix: [
    { texte: "Si vous maîtrisez la Discipline Kaï du Sixième Sens", vers: "96", requis: {"discipline":"sixieme-sens"} }
  ],
  evenement: {
        type: "jet-hasard-table",
        branches: {
        "0-4": { vers: "46", texte: "Si vous tirez un chiffre entre 0 et 4," },
        "5-9": { vers: "112", texte: "Entre 5 et 9," }
      }
      }
  },
  {
  ...
  {
  id: "128",
  texte: "Une lueur dorée parcourt la lame du Glaive lorsque vous le levez au-dessus de votre tête pour faire face à l'ennemi. Vous êtes attaqué par six ZOMBIES terrifiants que vous devez combattre en les considérant comme un seul et même adversaire. Ce sont des morts vivants et la puissance du Glaive de Sommer vous permet donc de multiplier par deux tous les point d'ENDURANCE qu'ils perdront au cours du combat. Ils restent cependant insensibles à la Discipline Kaï de la Puissance Psychique.",
  suite: "237",
  combat: { nom: "Zombies", habilete: 13, endurance: 19, immunisePsychique: true, vulnerableGlaiveSommer: true }
  },
  {
  id: "129",
  ...
  texte: "Le chef s'écroule dans le caniveau. Un premier voleur bondit à son tour, poignard au poing.",
  suite: "131-c",
  ...
  choix: [
    ...
    { texte: "Affronter le Monstre d'Enfer sans la lance", vers: "304", montreToujours: true }
  ]
  },
  {
  id: "135",
  ...
  {
  id: "136",
  texte: "« Il vous en coûtera 20 Couronnes pour vous rendre à Port Bax », lance le cocher qui s'exprime avec un fort accent de Ragadorn.",
  choix: [
    { texte: "Demander un billet pour Port Bax (20 PO)", vers: "10", requis: {"or":20}, effets: { or: -20 } },
    { texte: "N'avoir pas d'argent", vers: "238", montreToujours: true }
  ]
  },
  {
  id: "137",
  texte: "Vous arrivez à un croisement ; la rue du Mendiant tourne en direction du sud et aboutit à la rue du Chevalier Noir. Quelques mètres plus loin, une autre voie, la rue de l'Ancre, mène en direction de l'est. La pluie tombe de plus en plus dru, à présent.",
  choix: [
    { texte: "Si vous souhaitez aller vers le sud le long de la rue du Chevalier Noir", vers: "259" },
    { texte: "Si vous préférez suivre la rue de l'Ancre en direction de l'est", vers: "20" }
  ]
  },
  {
  id: "138",
  texte: "Au bout d'une heure de marche, vous atteignez le sommet d'une colline. Devant vous s'étend la forêt de Durenor. La route s'oriente vers l'est et s'enfonce sous les arbres à proximité d'une grande tour de bois. Vous apercevez devant la tour un soldat en faction.",
  choix: [
    { texte: "Si vous voulez poursuivre votre chemin en direction de la tour", vers: "232" },
    { texte: "Si vous préférez éviter le garde, faites un large détour et pénétrez dans la forêt plus loin au sud", vers: "244" }
  ]
  },
  {
  id: "139",
  ...
  choix: [
    { texte: "Si vous voulez aller vers l'est", vers: "27" },
    { texte: "Si vous préférez prendre la direction de l'ouest", vers: "114" }
  ]
  },
  {
  id: "140",
  ...
  {
  id: "157",
  texte: "Le GARDE est furieux et il se précipite sur vous en dévalant l'escalier, son épée levée au-dessus de sa tête. Si vous ne possédez pas d'arme, réduisez de 4 points votre total d'HABILETÉ et battez-vous à mains nues.",
  suite: "331",
  combat: { nom: "Garde", habilete: 15, endurance: 22, fuite: [{ texte: "Prendre la fuite", vers: "65" }] }
  },
  {
  id: "158",
  texte: "Le MOINE ne semble pas surpris par votre attaque et il tire lui-même une épée noire de sous sa robe de bure.",
  suite: "220",
  combat: { nom: "Moine", habilete: 16, endurance: 23 }
  },
  {
  id: "159",
  ...
  fin: "mort",
  nomFin: "Fin tragique — §159"
  },
  {
  id: "160",
  titre: "Prouver votre identité",
  texte: "« Pardonnez-moi, my lord, je ne voulais pas vous faire peur. » L'homme semble inquiet et la main ouverte qu'il tend vers vous ne cesse de trembler. Sans vous départir de votre prudence, vous acceptez son geste amical et quelques instants plus tard vous vous asseyez avec lui à l'une des tables de l'auberge dans laquelle vous êtes entré par une porte latérale. L'endroit est désert, à l'exception d'un couple de souris qui rongent un gros morceau de fromage. « Le capitaine Kelman m'a chargé de vous amener à bord du Sceptre Vert mais je dois tout d'abord m'assurer que vous êtes bien le Seigneur Kaï qu'on appelle le Loup Solitaire, dit l'homme ; pouvez-vous donner la preuve de votre identité 1 » Le meilleur moyen de prouver que vous êtes bien le Loup Solitaire consiste à faire la démonstration que vous maîtrisez l'une des Disciplines Kaï.",
  choix: [
    { texte: "Guérison : soigner une blessure ouverte", vers: "16", requis: {"discipline":"guerison"} },
    { texte: "Puissance Psychique : projeter la douleur", vers: "133", requis: {"discipline":"puissance-psychique"} },
    { texte: "Maîtrise des Armes : le tourbillon d'acier", vers: "255", requis: {"discipline":"maitrise-armes"} },
    { texte: "Communication Animale : le fromage des souris", vers: "203", requis: {"discipline":"communication-animale"} },
    { texte: "Maîtrise Psychique de la Matière : la chope flottante", vers: "48", requis: {"discipline":"maitrise-matiere"} },
    { texte: "Ne rien démontrer et quitter l'homme", vers: "348", montreToujours: true }
  ]
  },
  {
  id: "161",
  ...
  {
  id: "162",
  texte: "Il lance son cri de guerre et se rue sur vous.",
  suite: "302",
  combat: { nom: "Chevalier de la Montagne Blanche", habilete: 20, endurance: 27, fuite: [{ texte: "Prendre la fuite", vers: "244" }] }
  },
  {
  id: "163",
  ...
  choix: [
    ...
    { texte: "Si vous préférez continuer votre chemin sans vous occuper des marches", vers: "256" },
    { texte: "Si vous maîtrisez la Discipline Kaï du Sixième Sens", vers: "172", requis: {"discipline":"sixieme-sens"} }
  ]
  },
  {
  id: "165",
  ...
  choix: [
    ...
    { texte: "Si vous préférez vous enfuir en sautant par-dessus bord", vers: "267" }
  ]
  },
  {
  id: "167",
  ...
  {
  id: "171",
  texte: "Vous apercevez derrière les arbres une large route qui longe la côte d'est en ouest.",
  choix: [
    { texte: "Si vous voulez aller vers l'est", vers: "27" },
    { texte: "Si vous préférez vous diriger vers l'ouest", vers: "114" }
  ]
  },
  {
  id: "172",
  texte: "Grâce à votre Sixième Sens, vous devinez qu'un péril vous menace dans l'ombre de cette plate-forme.",
  choix: [
    { texte: "Si vous souhaitez malgré tout monter les marches et affronter ce danger", vers: "52" },
    { texte: "Si vous préférez vous éloigner rapidement de ces marches et de cette plate-forme", vers: "256" },
    { texte: "Enfin, si vous choisissez de revenir en courant jusqu'au croisement pour prendre le tunnel de gauche", vers: "64" }
  ]
  },
  {
  id: "173",
  titre: "Le grand magasin de Ragadorn",
  texte: "Vous pénétrez dans un somptueux magasin où sont exposées les marchandises les plus raffinées qu'on puisse trouver au nord de Magnamund. Même à cette heure tardive, l'endroit est animé : des capitaines et de riches commerçants marchandent en effet l'achat ou l'échange de leurs denrées. Le propriétaire du magasin est un jeune guerrier qui préside aux enchères du haut d'un fauteuil de bois sculpté suspendu par quatre chaînes. Ces hommes sont tous vêtus d'armures noires et leurs boucliers portent pour emblème l'image d'un vaisseau noir surmonté d'une crête rouge. Vous surprenez alors un jeune garçon en train de voler la bourse accrochée à la ceinture d'un marchand. Son forfait accompli, le garnement glisse son butin dans sa botte.",
  choix: [
    { texte: "Si vous décidez d'attraper le garçon pour lui faire rendre la bourse", vers: "91" },
    { texte: "Si vous préférez suivre le jeune homme au-dehors et lui dérober la bourse à votre tour", vers: "6" },
    { texte: "Enfin, si vous choisissez de faire comme si vous n'aviez rien vu pour consacrer plutôt votre attention aux marchandises exposées", vers: "283" }
  ]
  },
  {
  id: "174",
  ...
  {
  id: "175",
  texte: "« Il semble que l'oiseau se soit envolé », dit le capitaine. Il vous montre alors un canot qui file à bonne allure en direction d'un autre navire. « Regardez bien ce vaisseau, il n'a pas de pavillon et sa forme me paraît bien étrange. Je n'en ai encore jamais vu de semblable. » Vous observez le canot qui rejoint en quelques instants le mystérieux navire. Et soudain, comme par magie, un brouillard venu d'on ne sait où se lève sur la mer et enveloppe le vaisseau. Moins d'une minute plus tard, le navire et le brouillard ont tous deux disparu. Utilisez la Table de Hasard pour obtenir un chiffre.",
  evenement: {
        type: "jet-hasard-table",
        branches: {
        "0-4": { vers: "53", texte: "Si vous tirez un chiffre entre 0 et 4," },
        "5-9": { vers: "209", texte: "Entre 5 et 9," }
      }
      }
  },
  {
  ...
  choix: [
    ...
    { texte: "Si vous préférez ne pas attaquer les cavaliers", vers: "277" },
    { texte: "Enfin, si vous maîtrisez la Discipline Kaï du Sixième Sens", vers: "322", requis: {"discipline":"sixieme-sens"} }
  ]
  },
  {
  id: "177",
  texte: "Lorsque vous entrez à nouveau dans la taverne, vous voyez les marins rassemblés autour d'une table où se déroule une partie de bras de fer.",
  choix: [
    { texte: "Si vous souhaitez vous aussi engager une partie de bras de fer", vers: "276" },
    { texte: "Si vous préférez parler à l'aubergiste", vers: "342" }
  ]
  },
  {
  id: "178",
  ...
  {
  id: "179",
  texte: "Votre maîtrise du Camouflage vous permet de vous dissimuler dans la charrette à foin en étant sûr de n'être pas découvert. Lorsque, enfin, tout danger est écarté, vous sortez de votre cachette.",
  choix: [
    { texte: "Si pour plus de sûreté, vous souhaitez rester caché un peu plus longtemps, vous pouvez vous réfugier au sommet d'une autre meule de foin entassée à quelque distance", vers: "82" },
    { texte: "Si vous préférez prendre un cheval et quitter le village", vers: "150" },
    { texte: "Si enfin vous choisissez d'entrer dans la boutique du charron", vers: "71" }
  ]
  }
];
