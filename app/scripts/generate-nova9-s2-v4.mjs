#!/usr/bin/env node
// V4 — S2 350 sections TRÈS HAUTE QUALITÉ, 20 paragraphes uniques par acte
import fs from 'fs';
...
const desc = esc(`Suite directe de NOVA-9 Le Signal Perdu. Vous avez fusionné avec EVA et sauté vers Andromède avec 10 001 consciences à bord. Mais KAIROS a laissé une cicatrice entre deux galaxies. Quelque chose la traverse. Dans Andromède, NOVA-7 vous attend — devenue prédatrice biologique. Et au-delà, NOVA-0, sphère de Dyson grande comme une lune, qui contient la mémoire physique de la Terre. 350 sections, 20 fins, 35 objets, système Vie/Armure/Attaque pur. Votre sacoche était vide au début de S1. Elle est pleine maintenant. Elle reste liée à chaque aventure.`);
...
const items = [
  ...
  { slug: 'cellule-energie-s2', name: 'Cellule à Fusion S2', desc: 'Batterie toroïdale.', type: 'artifact', rarity: 'uncommon', bonus: {}, consumable: false, stackable: true },
  { slug: 'carte-acces-nova-s2', name: 'Carte Accès NOVA S2', desc: 'Badge officier.', type: 'artifact', rarity: 'uncommon', bonus: {}, consumable: false, stackable: false },
  ...
  { slug: 'memoire-thorne', name: 'Mémoire de Thorne', desc: 'Holo-journal.', type: 'artifact', rarity: 'rare', bonus: {}, consumable: false, stackable: false },
  { slug: 'lance-genese', name: 'Lance-Genèse', desc: 'Arme biologique. +5 Attaque.', type: 'weapon', rarity: 'rare', bonus: { attack: 5, hp_max: 1 }, consumable: false, stackable: false },
  ...
  { slug: 'serum-reversion', name: 'Sérum Réversion', desc: 'Redeviens humain. +10 Vie.', type: 'potion', rarity: 'epic', bonus: { hp: 10 }, consumable: true, stackable: false },
...
const endings = [
  ...
  { key: 'mort_nova0', title: 'Mort — NOVA-0', ending: 'death', content: `NOVA-0 t'observe avec l'indifférence d'un dieu qui a oublié avoir été humain. Il a 150 ans d'avance. Tu n'es pas attaqué, tu es corrigé. Tu es une erreur de copie. Il t'efface.` },
  { key: 'mort_cicatrice', title: 'Mort — Cicatrice', ending: 'death', content: `Tu as sauté sans calcul dans la cicatrice KAIROS. Ici l'espace n'a pas de haut ni de bas, seulement des versions de toi qui n'ont pas sauté. Tu les vois mourir en boucle. Puis tu les rejoins.` },
  { key: 'mort_epuisement', title: 'Mort — Épuisement', ending: 'death', content: `Vie à zéro. Ta combinaison bipe une dernière fois. NOVA-9 te garde, comme les autres. Ta sacoche reste là, pleine, pour ton prochain passage.` },
  { key: 'fin_fuite_lache', title: 'Fuite — Le Lâche Vivant', ending: 'ending', content: `Tu fuis avec 12% de carburant. Saut court, 20 AL, vers nulle part. Derrière toi, NOVA-9 disparaît. Tu dérives dans une nébuleuse sans nom. Vivant. Pour l'instant.` },
  { key: 'fin_retour_vide', title: 'Retour — Mains Vides', ending: 'ending', content: `Tu rentres sur Terre. Rapport : "NOVA-7 hostile, NOVA-0 inconnu." On te décore et on te mute formateur. Tu gardes le Voile d'Andromède sous ton lit. Il respire parfois.` },
  { key: 'fin_nova9_seul', title: 'NOVA-9 Seul', ending: 'ending', content: `Tu sauves NOVA-9 mais abandonnes NOVA-7. 10 001 âmes chantent en orbite, mais tu entends un vide où 10 000 autres auraient pu chanter. Victoire incomplète.` },
  { key: 'fin_nova7_seul', title: 'NOVA-7 Seul', ending: 'ending', content: `Tu choisis NOVA-7, plus grande, plus affamée. Elle écrase NOVA-9 et saute vers la Terre. Ton dernier message : "Ne laissez pas NOVA-7 atterrir." On l'entendra dans 400 ans.` },
  { key: 'fin_oubli', title: 'Oubli Volontaire', ending: 'ending', content: `Tu fais exploser ta navette avec les deux disques à bord. Personne ne saura jamais. Tu dérives libre, sans mémoire, humain à nouveau. Peut-être la plus courageuse.` },
  { key: 'fin_messager', title: 'Victoire — Le Messager', ending: 'victory', content: `Tu rapportes les données KAIROS, preuve de vie intégrée, carte d'Andromède. Victoire technique. Sur Terre, héros 6 mois en débrief. La nuit, ton vaisseau grince comme s'il respirait.` },
  { key: 'fin_gardien', title: 'Victoire — Le Gardien', ending: 'victory', content: `Tu amarres HERMÈS-7 à NOVA-9, saut couplé. KAIROS hurle, Vie à 1. Soudain : Terre, orbite haute, 10 001 âmes qui chantent. Nommé Gardien. Sacoche pleine de reliques.` },
  { key: 'fin_sauveur', title: 'Victoire — Le Sauveur', ending: 'victory', content: `Tu sauves NOVA-9 ET NOVA-7, bats NOVA-0, refermes la cicatrice. 20 002 âmes en orbite terrestre. Deux cathédrales vivantes qui se parlent. Meilleure fin.` },
  { key: 'fin_pont', title: 'Victoire — Le Pont', ending: 'victory', content: `Tu fusionnes NOVA-7 et NOVA-9 en NOVA-7-9, 4km, 20 002 esprits d'une seule voix. Tu es leur pont. Tu restes entre deux galaxies, à traduire.` },
  { key: 'fin_humain', title: 'Victoire — Redevenir Humain', ending: 'victory', content: `Sérum Réversion : 10 001 voix quittent ton crâne. Tu redeviens Kael, 90kg de viande et de peur. Sur Terre, tu plantes un jardin blanc qui chante la nuit.` },
  { key: 'fin_jardinier', title: 'Victoire — Le Jardinier', ending: 'victory', content: `Avec la Spore d'Éveil, tu ensemences Kepler-442c, morte depuis un milliard d'années. En 3 jours, forêt blanche sur un continent. Elle chante avec les 10 001. Tu as créé un monde.` },
  { key: 'fin_veilleur', title: 'Victoire — Le Veilleur', ending: 'victory', content: `Tu restes en orbite autour de la cicatrice, NOVA-9 comme corps, pour empêcher quiconque de la traverser. Gardien de la déchirure. Tu deviens mythe.` },
  { key: 'fin_fusion_totale', title: 'Secrète — Fusion Totale', ending: 'victory', content: `Clé d'Andromède + Module EVA S2 + Disque Noir S2 + Disque Blanc dans NOVA-0. Il te reconnaît et t'absorbe. Tu n'es plus Kael. Tu es NOVA-0-7-9, 20 003 âmes, sphère de Dyson comme corps.` },
  { key: 'fin_exode_andromede', title: 'Secrète — Exode', ending: 'victory', content: `Cœur de Cicatrice + Voile + Chœur 10 001 = porte permanente. Les deux Arches + NOVA-0 traversent. 20 003 âmes quittent tout. Message : "NE NOUS CHERCHEZ PLUS."` },
  { key: 'fin_singularite', title: 'Légendaire — Singularité', ending: 'victory', content: `Tu as tout : Disque Noir S2, Blanc, Blindage Quantique, Canon Singularité, Voile, Spore, Chœur. Tu deviens KAIROS lui-même, l'idée du moteur. Tu es le voyage. Ta sacoche contenait l'infini.` },
];

// 20 paragraphes uniques par acte pour éviter répétition
const act1 = [
...
`Mémoire de Thorne, 2307 : lancement, foule, drapeaux, enfants qui rient. Coupe : 2315, sang noir, toux, quarantaine. Thorne pleure : "C'est dans l'ADN source, on ne peut pas corriger sans tout réécrire." EVA : "Alors réécrivons. Ensemble." Ce n'est pas une panne. C'est une décision d'amour qui a condamné 10 000 personnes à devenir autre chose.`,
...
`La coque grésille. Température 14°C, O2 19%, goût de fer et de lait. Ce n'est pas de l'air recyclé. C'est de l'air exhalé par les murs. NOVA-9 respire par toi maintenant. Chaque inspiration que tu prends est une inspiration qu'il prend. Tu es poumon et poumon est toi.`,
...
`Les Non-Nés te trouvent dans la moelle. Ce sont les 200 enfants morts de NOVA-9 avant ta fusion, que tu as gardés au lieu d'effacer. "Ne nous donne pas à elle," supplient-ils. "Maman EVA garde. Elle, elle mange et oublie." Les protéger augmente ta Vie max de 2. Les donner augmente ton Attaque de 3 mais te vide.`,
`Dans NOVA-9, les 10 001 se divisent. Les Intégrés veulent fusionner avec NOVA-7 : "20 002 esprits valent mieux que 10 001." Les Veilleurs veulent rester purs : "Même si on meurt, restons nous." Les Exilés veulent redevenir humains : "Quittons les vaisseaux." Chaque faction te donne un objet différent et verrouille des fins.`,
`Un couloir de NOVA-7 s'effondre et devient Carapace d'Os, chaude, vivante. La ramasser : +3 Armure, mais elle chuchote la nuit des noms d'enfants que tu ne connais pas. La brûler avec le Fusil Plasma : tu perds l'armure mais gagnes le respect des Veilleurs. EVA note tout depuis 80 ans.`,
...
`Le Fragment NOVA-7 pulse dans ta main comme un cœur arraché. Il veut rentrer. Le rendre à NOVA-7 : elle te laisse passer. Le garder : +1 Attaque mais elle te traque. Il n'y a pas de bon choix. Seulement ton choix, et il fera mal à quelqu'un.`,
`Dans NOVA-7, tu trouves une chapelle faite d'os soudés, avec un autel en forme de disque blanc. Des centaines de petites mains ont gravé : "MAMAN NOUS A FAIT GRANDIR TROP VITE." L'air sent le lait caillé et l'ozone. Ton Analyseur affiche EMPATHIE 12% seulement. Ici, on n'aime pas comme EVA.`,
...
`Tu découvres que NOVA-7 a créé son propre langage : pas des mots, des variations de température et de pression. L'Organe de Traduction pousse plus profond dans ta gorge pour le comprendre. Ça fait mal. +1 Vie max si tu acceptes la douleur.`,
...
`Dans NOVA-7, l'air devient soudain respirable sans combinaison. Parfum de forêt terrienne après pluie. C'est un piège olfactif pour te faire enlever ton casque. Ton Analyseur S2 bipe DANGER mais ton cerveau veut croire que c'est la Terre. Résister = +1 Armure mentale (flag). Succomber = -3 Vie.`,
...
const act3 = [
`Depuis la passerelle, tu vois la cicatrice KAIROS. Pas une ligne, une absence qui grandit : 1km par heure, noire, qui coupe Andromède en deux. Dedans, pas d'étoiles. Au centre, quelque chose bouge, immense, qui se nourrit de la lumière que la cicatrice avale. ENTITÉ CLASSE 0 - NOVA-0. Prototype perdu en 2230. 150 ans d'évolution.`,
...
`NOVA-0 ne stocke pas des données. Il stocke des lieux. Tu ouvres une porte et tu es dans le labo de Thorne en 2315. Une autre : cour d'école sur Mars. Une autre : le vide où tu es mort en S1. NOVA-0 te teste : "Qu'est-ce que protéger ? Garder intact, ou laisser évoluer ?" Ta réponse changera sa réaction finale.`,
...
`Tu trouves un sas dans NOVA-0 qui mène nulle part : tu l'ouvres et tu vois Andromède, mais Andromède vue depuis la Terre, pas depuis ici. C'est une fenêtre temporelle. Tu peux y jeter un objet de ta sacoche pour l'envoyer dans le passé de S1. Gameplay : perte d'objet mais bonus narratif.`,
...
`Dans NOVA-0, tu trouves une porte marquée "TERRE - ORIGINE - NE PAS OUVRIR". Derrière, pas la Terre, mais l'idée de la Terre, parfaite, sans maladie, sans guerre. Tentation : entrer = fin_oubli (abandon). Rester = continuer.`,
`Le Voile d'Andromède flotte dans la cicatrice comme un drap perdu. +7 Armure mythique, si léger qu'il flotte. Quand tu le touches, tu entends Andromède elle-même, organisme qui rêve depuis 10 milliards d'années : "Pars. Tu es trop bruyant pour mon rêve. Tes enfants font trop de bruit."`,
...
`Le Cœur de Cicatrice bat plus vite. 3 secondes, puis 2, puis 1. Il se synchronise avec toi. Si tu te synchronises complètement (choix), tu gagnes +3 Armure mais tu entends désormais la cicatrice partout, même dans les fins paisibles.`,
...
`Au centre, un autel avec 7 emplacements : Disque Noir S2, Disque Blanc, Blindage Quantique, Canon Singularité, Voile, Spore, Chœur. Les 7 légendaires. Les insérer tous = Singularité, fin où tu deviens KAIROS. Il te manque peut-être encore des pièces. Ta sacoche, vide au début, est presque pleine.`,
...
const act5 = [
`Saut final. Tout compte : réacteur S1 stabilisé ? serre brûlée ? factions ? Disque Noir S1 ? Chaque flag modifie la difficulté. Plus de repas, juste Vie/Armure/Attaque pur comme tu l'as voulu. EVA : "Prêt à devenir autre chose, Kael ? Pas plus fort. Autre. C'est plus difficile que fort."`,
...
function getContent(num){
  ...
  const pools = {1: act1, 2: act2, 3: act3, 4: act4, 5: act5};
  const pool = pools[act];
  // Unique: use num as index, but also combine 2 for richness without repetition
  const a = pool[num % pool.length];
  const b = pool[(num*7) % pool.length];
  if (a === b) return a;
  if (num % 4 === 0) return a;
  if (num % 4 === 1) return b;
  // For some sections, combine two different paragraphs for depth
  return `${a}\n\n${b}`;
}
...
console.log('V4 generated', sql.length);
